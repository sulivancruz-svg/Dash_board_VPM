  ...
  return (
    <div className="rounded border border-cyan-400/15 bg-[#0B2440] p-5 shadow-[0_14px_35px_rgba(0,0,0,0.24)]">
      ...
      <ResponsiveContainer width="100%" height={height}>
        <LineChart data={data} margin={{ top: 10, right: hasRightAxis ? 28 : 20, left: 0, bottom: 8 }}>
          <CartesianGrid strokeDasharray="3 3" stroke="rgba(148, 163, 184, 0.18)" />
          <XAxis dataKey="date" tick={{ fill: '#B9D7F3', fontSize: 12 }} axisLine={{ stroke: '#234B70' }} tickLine={false} />
          <YAxis
            yAxisId="left"
          ...
          <Tooltip
            ...
            formatter={(value: any, name: any) => {
              ...
              return label.toLowerCase().includes('receita') || label.toLowerCase().includes('faturamento')
